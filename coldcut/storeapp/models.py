...
# Multiple store images can be assigned to a single product (just like on amazon.com)
...
class Order_Item(models.Model):
    product = models.ForeignKey(Store_Item, on_delete=models.SET_NULL, blank=True, null=True)
